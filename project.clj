(defproject atom-packages-evolution "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "atom_packages_evolution.jar"
  ...
  :cljsbuild {:builds [{:id           "production"
                        ...
                        :compiler     {:asset-path    "js/prod"
                                       :main          atom-packages-evolution.client-main
                                       :optimizations :advanced
                                       :source-map    "resources/public/js/atom_packages_evolution.js.map"
                                       :output-dir    "resources/public/js/prod"
                                       :output-to     "resources/public/js/atom_packages_evolution.js"}}]}

  :profiles {:uberjar    {:main           atom-packages-evolution.server-main
                          :aot            :all
                          ...
                          :cljsbuild    {:builds
                                         [{:id           "dev"
                                          ...
                                          {:id           "test"
                                           ...
                                           :figwheel     {:on-jsload "atom-packages-evolution.client-test-main/client-tests"}
                                           :compiler     {:asset-path    "js/test"
                                                          :main          atom-packages-evolution.client-test-main
                                                          :optimizations :none
                                          ...
                                          {:id           "automated-tests"
                                           ...
                                           :compiler     {:asset-path    "js/ci"
                                                          :main          atom-packages-evolution.CI-runner
                                                          :optimizations :none
                                          ...
                                          {:id           "cards"
                                           ...
                                           :compiler     {:asset-path           "js/cards"
                                                          :main                 atom-packages-evolution.cards
                                                          :optimizations        :none
